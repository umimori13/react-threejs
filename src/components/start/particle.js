...
export default class Particle extends Group {
    ...
    initPoints() {
        ...
        //     console.log('e :>> ', e)
        //     console.log('e :>> ', e.element[0])
        //     const i =
        //         e.element[0].uv.x * this.width +
        //         e.element[0].uv.y * this.height * this.width
        //     if (
        //         originalColors[i * 4 + 0] > highThreshold &&
        //         originalColors[i * 4 + 1] > highThreshold &&
        //         originalColors[i * 4 + 2] > highThreshold
        ...
        //                 moveBuffer[index * 3] = e.element[0].uv.x
        //                 moveBuffer[index * 3 + 1] = e.element[0].uv.y
        //                 moveBuffer[index * 3 + 2] = 0
        //                 this.counter++
        //             }
        //         }
        //         if (!this.isIncreasing) this.isIncreasing = true
